...
public class SendMailUtil {
    ...
    public static String myEmailAccount = "1078508565@qq.com";
    public static String myEmailPassword = "ypbwhytixxffjedc";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "lizl@i2finance.net";
